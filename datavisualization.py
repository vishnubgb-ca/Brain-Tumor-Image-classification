...
def visualise_image():
    ...
    glioma_tumor_image = open_random_image("Training/glioma_tumor/")
    meningioma_tumor_image = open_random_image("Training/meningioma_tumor/")
    no_tumor_image = open_random_image("Training/no_tumor/")
    pituitory_tumor_image = open_random_image("Training/pituitory_tumor/")
